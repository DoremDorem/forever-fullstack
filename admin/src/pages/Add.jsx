...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='relative flex flex-col w-full items-start gap-3'>
        <div>
        ...
        <button className='w-28 cursor-pointer py-3 mt-4 bg-black text-white' type="submit">Add</button>
