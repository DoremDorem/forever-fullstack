    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
           ...
           <p className='text-gray-500'>226021 Faizullaganj near Pani tanki <br />Lucknow, Uttar Pradesh</p>
           <p className='text-gray-500'>Tel (91) 9919524188 <br /> Email: mauryaakashkumar313@gmail.com</p>
